...
export function ContextHeader({ submission, onBack }: ContextHeaderProps) {
  ...
  return (
    <header className="bg-surface px-8 pb-8 pt-6">
      {onBack && (
        <button
          type="button"
          onClick={onBack}
          className="mb-4 inline-flex items-center gap-2 text-[13px] font-medium text-muted transition-colors hover:text-ink"
        >
      ...
      <div className="flex flex-wrap items-start justify-between gap-6">
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="pt-1 text-[14px] text-body">
