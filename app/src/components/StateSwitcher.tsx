...
function Pill({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={[
        'rounded-md px-2 py-[3px] text-[11px] font-medium transition duration-[var(--dur-fast)] ease-[var(--ease-out)] active:scale-95',
        active
  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-[84px] right-4 z-40 flex items-center gap-2 rounded-full border px-4 py-2 text-[12px] font-medium text-muted transition duration-[var(--dur-fast)] ease-[var(--ease-out)] hover:text-ink active:scale-95 lg:bottom-4"
        style={{
    ...
    >
      <div className="mb-3 flex items-center justify-between">
        ...
        <button
          ...
          className="text-[12px] font-medium text-muted transition duration-[var(--dur-fast)] ease-[var(--ease-out)] hover:text-ink active:scale-95"
        >
          Hide
        </button>
      </div>
      ...
      <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-1">
            {props.submissions.map((s) => (
              <button
                ...
                className={[
                  'flex items-center justify-between rounded-md px-2 py-[6px] text-left text-[12px] transition duration-[var(--dur-fast)] ease-[var(--ease-out)] active:scale-[0.98]',
                  s.id === props.activeId
        ...
        <div className="flex items-center justify-between pt-1">
          <button
            ...
            className="rounded-md border border-border px-3 py-[5px] text-[12px] font-medium text-body transition duration-[var(--dur-fast)] ease-[var(--ease-out)] hover:border-accent hover:text-accent active:scale-95"
          >
